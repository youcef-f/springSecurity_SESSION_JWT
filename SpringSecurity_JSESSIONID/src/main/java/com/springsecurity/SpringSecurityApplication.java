...
public class SpringSecurityApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		AppRole roleadmin = accountService.saveRole(new AppRole(null, "ADMIN"));
		AppRole roleops = accountService.saveRole(new AppRole(null, "OPS"));
		AppRole rolemon = accountService.saveRole(new AppRole(null, "MON"));
		AppRole roleread = accountService.saveRole(new AppRole(null, "READ"));
		...
		appUserRepository.findAll().forEach(u -> {
			System.out.println(
					"role id: " + u.getId() + " username : " + u.getUsername() + " password:  " + u.getPassword());
		});
	}
